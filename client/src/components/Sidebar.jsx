...
const SIDEBAR_BG = "#C5D8F5";
const TITLE_COLOR = "#1B2DB5";
...
export default function Sidebar({ settings }) {
  ...
  const tickerText = `Currently in  ⊕  ${settings.current_location}  ⊕  ${settings.latitude}  ⊕  ${settings.longitude}  ⊕  `;
